// create course
// create section
// delete section  -- u have to add model for deleting a SEction
// update section
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full bg-richblack-600 flex items-center justify-center shrink-0">
                    <span className="text-[10px] text-richblack-300 font-semibold">{i + 1}</span>
                  </div>
                ...
                <div className="flex items-center gap-1">
                  <button
                    type="button"
                    onClick={(e) => handleEditSubSection(e, data, section._id)}
                  ...
                  <button
                    type="button"
                    onClick={(e) => handleDeleteSubSection(data._id, section._id, e)}
