...
import {
  ...
  resetPassword,
} from "../services/opeartions/authApi";
...
const ResetPasswordLink = () => {
  ...
  async function handle() {
    await getResetPasswordToken(email, setSetMail);
  }
          ...
          <div className="w-127 p-8 flex flex-col gap-6">
            <div className="space-y-3 w-full">
              ...
              <p className="font-inter font-normal text-[18px] text-richblack-100">
                All done! We have sent an email to m***********@gmail.com to
                confirm
              </p>
            </div>
        ...
        <div className="bg-richblack-900 h-screen w-screen flex flex-col justify-center items-center">
          <div className="flex flex-col items-center  w-127 p-8 gap-6">
            ...
            <div className="w-full space-y-3">
              <button
                onClick={handle}
                className="font-inter font-medium text-[16px] text-richblack-900 rounded-lg p-3 bg-yellow-50 w-full cursor-pointer"
              >
...
export { ResetPassword, ResetPasswordLink };
